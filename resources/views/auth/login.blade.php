...
<div class="container-fluid h-100">
    <div class="row justify-content-center border border-2 h-100 py-5">
     <div class="col-md bg-turquoise d-flex justify-content-center align-items-center">
        <div class="logo border border-2 h-75 w-50 ">logo</div>
     </div>
     <div class="col-md w-100">
        <form method="POST" action="{{ route('register') }}">
            @csrf
            <h3 class="fw-bold mt-3 text-center" style="text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Welcome back to SHIP!</h1>
            <div class="mb-3">
            ...
            <div class="my-3">
                <button type="submit" class="btn bg-turquoise w-100">
                        {{ __('Login') }}
                </button>
            </div>
        </form>
